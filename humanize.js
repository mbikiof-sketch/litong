...
function humanizeTopLevelFaqAnswer(s) {
  ...
  if (s.startsWith('Request a quote through multiple convenient channels:')) {
    return 'You can request a quote several ways. Submit an RFQ through our website contact form with part numbers and quantities. Email your BOM to hk@ic-distributor.com with project details and target delivery. Call +86 15013702378 for urgent requirements. Message us on WhatsApp or WeChat for quick quotes on standard products. We need part numbers, quantities, required delivery date, target price if known, end application, and annual forecast for volume pricing. Standard products: 1-2 business days response. Special configurations: 3-5 business days. We offer competitive tiered pricing and can match or beat competitor pricing for qualified opportunities. Our FAE team can also review your BOM for optimization and alternatives.';
  }
  ...
  if (s.startsWith('BeiLuo Electronics provides comprehensive technical support:')) {
    return 'We offer dedicated Field Application Engineers with deep Semikron product expertise, schematic review, PCB layout guidance, thermal analysis, and component selection. We also provide troubleshooting, failure analysis, and optimization recommendations, plus access to Semikron reference designs and evaluation kits. You\'ll get datasheets, application notes, simulation models, and software libraries. Product training and application workshops are available. Technical inquiries are typically answered within 24-48 hours, and on-site support is available for major customers and complex projects. Reach us by email at hk@ic-distributor.com, phone at +86 15013702378, or WhatsApp/WeChat. Our FAE team has extensive experience with motor drives, power supplies, renewable energy, and industrial applications using Semikron components.';
  }
  ...
  data.faq.forEach(f => {
    if (f.answer) {
      f.answer = f.answer
        ...
        .replace(/Yes, our FAE team provides comprehensive design-in support including component selection, schematic review, thermal analysis, PCB layout guidance, and troubleshooting\. Contact our technical support at support@ic-distributor\.com\./, 'Yes, our FAE team provides design-in support including component selection, schematic review, thermal analysis, PCB layout guidance, and troubleshooting. Contact our technical support at support@ic-distributor.com.');
    }
  });
}
