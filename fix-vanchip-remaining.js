...
// 修复shortDescription长度超限的产品
const shortDescFixes = {
  'VC5755': 'Multi-band 5G PA module for n77/n78/n79 bands with integrated switch and high efficiency.',
  'VC7916': 'High-performance multi-band PA module with integrated filter for global 4G/5G devices.'
};
...
if (productUpdated > 0) {
  ...
  console.log(`\n✅ Updated ${productUpdated} products successfully!`);
}
...
// 修复Automotive V2X RF Solution的faeInsights
...
// 修复5G Small Cell RF Solution的faeInsights
...
if (solutionUpdated > 0) {
  ...
  console.log(`\n✅ Updated ${solutionUpdated} solutions successfully!`);
}

console.log('\n========================================');
console.log(`Total products updated: ${productUpdated}`);
console.log(`Total solutions updated: ${solutionUpdated}`);
console.log('========================================');
