...
console.log('🔧 修复chipanalog品牌FAQ长度问题 - 最终版...\n');
...
const generateFAQs = (partNumber) => [
  ...
  },
  {
    ...
    answer: `${partNumber}提供高达5000Vrms的隔离耐压能力，符合UL1577和IEC60747-5-5标准，适用于高隔离要求的工业和医疗应用。该隔离等级能够有效保护低压侧电路免受高压侧故障的影响，确保系统安全运行。reinforced isolation提供额外的安全裕度，满足最严格的安全标准要求，是工业和医疗设备的理想选择，能够有效防止电击风险，保障人身安全和设备安全。`,
    decisionGuide: '根据系统安全要求选择合适的隔离等级，确保满足应用的安全标准要求',
    keywords: ['隔离耐压', '安全认证', '绝缘']
  },
  {
    question: `${partNumber}的数据传输速率是多少？`,
    answer: `${partNumber}支持高速数据传输，最高可达150Mbps，满足大多数工业通信和数字隔离应用需求。高速传输能力使其适用于实时控制系统和高速数据采集应用，同时保持信号完整性和低延迟。低传播延迟确保高速通信的可靠性，适用于对时序要求严格的应用场景，如工业自动化和通信设备，能够满足现代工业系统的高速通信需求，提升系统整体性能和效率。`,
