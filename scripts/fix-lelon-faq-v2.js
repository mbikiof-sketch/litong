...
function generateFiveDimensionFaqs(product, categoryId) {
  ...
  const dim2ExtraFaq = {
    ...
    answer: `Industry best practice recommends operating aluminum electrolytic capacitors at no more than 80% of their rated voltage for general applications. For ${partNumber} with ${voltage} rating, the maximum recommended operating voltage is ${derated80}V. This 20% derating significantly improves reliability and extends operational lifetime by reducing stress on the dielectric. For critical applications, high-temperature environments, or when maximum lifetime is required, 50% derating to ${derated50}V is recommended. Voltage derating also provides safety margin for voltage transients, line regulation variations, and unexpected surge conditions. Operating consistently above 80% of rated voltage will accelerate aging and significantly reduce capacitor lifetime. Proper derating is essential for achieving the rated lifetime in your application.`,
  ...
  const dim5Faq = {
    ...
    answer: `Standard lead time for ${partNumber} is 4-6 weeks from Taiwan manufacturing. BeiLuo Electronics maintains safety stock for many popular Lelon series, enabling 1-3 day delivery for sample quantities from 1 to 100 pieces. Standard MOQ is 1,000 pieces with attractive price breaks at 5,000, 10,000, and 50,000 pieces quantities. For high-volume production requirements of 100,000 pieces or more annually, we can arrange quarterly scheduled deliveries with 4-week lead time and volume pricing discounts of 15-30% off standard pricing. Emergency air freight options are available to reduce lead time to 2-3 weeks with additional shipping cost. We also offer consignment inventory programs for qualified customers with predictable demand patterns. Current stock availability and competitive pricing can be confirmed by contacting our sales team directly.`,
    ...
    keywords: ['lead time', 'MOQ', 'delivery schedule', 'volume pricing']
  };
