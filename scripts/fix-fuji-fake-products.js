...
console.log('🔧 修复fuji所有分类的第5、6个产品...\n');
...
const realProducts = {
  ...
  'igbt_modules_5': {
    ...
    descriptionParagraphs: [
      ...
      'With its robust construction and high reliability, this module is suitable for demanding applications such as large industrial drives, wind turbine converters, and high-power UPS systems. The module meets industrial standards for quality and performance.'
    ],
    specifications: {
      'Current Rating': '800A',
...
function fixCategoryProducts(categoryIndex, categoryName, productKeys) {
  ...
  // 修复第5-6个产品 (索引4-5)
  for (let i = 0; i < 2; i++) {
    const productIndex = i + 4; // 从索引4开始（第5个产品）
