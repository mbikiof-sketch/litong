/**
 * Verify PineSemi product fields in detail
 */
...
console.log('=== PineSemi Product Fields Verification ===\n');
...
data.categories.forEach(category => {
  ...
  category.products.forEach((prod, idx) => {
    ...
    // Check for realistic specs (not 25V/1A fake data)
