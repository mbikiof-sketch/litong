...
const discreteCategory = productsData.categories.find(cat => cat.id === 'power-discrete');
  ...
  const additionalIGBTProducts = [
    {
      ...
      applications: ["Large Industrial Drives", "Heavy-Duty Motor Control", "High-Power Inverters", "UPS Systems"],
      features: ["600A high current capability", "Low Vce(sat) 1.75V", "6TC technology", "Standard 62mm package", "Excellent thermal performance"],
      alternativeParts: [
        { partNumber: "MMG400HB060C6C", brand: "MacMic", specifications: { voltage: "600V", current: "400A" }, comparison: "Lower current (400A vs 600A)", reason: "Cost optimization for lower power", useCase: "Medium power applications", link: "#" },
        { partNumber: "MMG800HB060C6C", brand: "MacMic", specifications: { voltage: "600V", current: "800A" }, comparison: "Higher current (800A vs 600A)", reason: "Higher power capability", useCase: "Maximum power applications", link: "#" }
      ],
      companionParts: [
    ...
    },
    {
      ...
      applications: ["Welding Machines", "Induction Heating", "High-Frequency Power Supplies", "High-Performance Motor Drives"],
      features: ["50kHz switching capability", "Low switching losses", "HN high-speed technology", "EconoDUAL package", "Fast switching characteristics"],
      alternativeParts: [
        { partNumber: "MMG75HB120HNS", brand: "MacMic", specifications: { voltage: "1200V", current: "75A" }, comparison: "Higher current (75A vs 50A)", reason: "More power headroom", useCase: "Higher power high-frequency apps", link: "#" }
      ],
      companionParts: [
...
if (fredCategory && fredCategory.products.length < 6) {
  ...
  const additionalFREDProducts = [
    {
      ...
      applications: ["SMPS Output Rectifiers", "Freewheeling Diodes", "Snubber Circuits", "High-Frequency Rectification"],
      features: ["200A current capability", "35ns fast recovery", "Soft recovery characteristics", "Low switching losses", "TO-247 package"],
      alternativeParts: [
        { partNumber: "MMF150ZB060", brand: "MacMic", specifications: { voltage: "600V", current: "150A" }, comparison: "Lower current (150A vs 200A)", reason: "Cost optimization", useCase: "Lower current applications", link: "#" }
      ],
      companionParts: [
    ...
    },
    {
      ...
      applications: ["1200V Motor Drives", "High-Voltage SMPS", "Industrial Inverters", "High-Voltage Rectification"],
      features: ["100A at 1200V", "50ns recovery time", "High-voltage capability", "Soft recovery", "TO-247 package"],
      alternativeParts: [
        { partNumber: "MMF75ZB120", brand: "MacMic", specifications: { voltage: "1200V", current: "75A" }, comparison: "Lower current (75A vs 100A)", reason: "Cost optimization", useCase: "Lower current 1200V apps", link: "#" }
      ],
      companionParts: [
    ...
    },
    {
      ...
      applications: ["High-Power SMPS", "Welding Equipment", "Large Motor Drives", "High-Current Rectification"],
      features: ["300A high current", "40ns recovery", "Low forward voltage", "High reliability", "TO-247 package"],
      alternativeParts: [
        { partNumber: "MMF200ZB060", brand: "MacMic", specifications: { voltage: "600V", current: "200A" }, comparison: "Lower current (200A vs 300A)", reason: "Cost optimization", useCase: "Medium current applications", link: "#" }
      ],
      companionParts: [
    ...
    },
    {
      ...
      applications: ["1200V Inverters", "Medium Motor Drives", "Power Supplies", "High-Voltage Rectification"],
      features: ["50A at 1200V", "45ns recovery", "Soft recovery", "Low EMI", "TO-247 package"],
      alternativeParts: [
        { partNumber: "MMF75ZB120", brand: "MacMic", specifications: { voltage: "1200V", current: "75A" }, comparison: "Higher current (75A vs 50A)", reason: "More current headroom", useCase: "Higher current 1200V apps", link: "#" }
      ],
      companionParts: [
...
if (discreteCategory && discreteCategory.products.length < 6) {
  ...
  const additionalDiscreteProducts = [
    {
      ...
      applications: ["DC-DC Converters", "Motor Drives", "Power Switching", "SMPS"],
      features: ["60A current capability", "Low 12mΩ Rds-on", "Fast switching", "TO-220 package", "High reliability"],
      alternativeParts: [
        { partNumber: "MMBT40N06", brand: "MacMic", specifications: { voltage: "60V", current: "40A" }, comparison: "Lower current (40A vs 60A)", reason: "Cost optimization", useCase: "Lower current applications", link: "#" }
      ],
      companionParts: [
    ...
    },
    {
      ...
      applications: ["100V Motor Drives", "DC-DC Converters", "Power Supplies", "Industrial Controls"],
      features: ["20A at 100V", "Low Rds-on", "Fast switching", "Rugged construction", "TO-220 package"],
      alternativeParts: [
        { partNumber: "MMBT30N10", brand: "MacMic", specifications: { voltage: "100V", current: "30A" }, comparison: "Higher current (30A vs 20A)", reason: "More current capability", useCase: "Higher current 100V apps", link: "#" }
      ],
      companionParts: [
    ...
    },
    {
      ...
      applications: ["200V Power Supplies", "Motor Drives", "Industrial Equipment", "High-Voltage Switching"],
      features: ["15A at 200V", "200V rating", "Avalanche capability", "Fast switching", "TO-220 package"],
      alternativeParts: [
        { partNumber: "MMBT10N20", brand: "MacMic", specifications: { voltage: "200V", current: "10A" }, comparison: "Lower current (10A vs 15A)", reason: "Cost optimization", useCase: "Lower current 200V apps", link: "#" }
      ],
      companionParts: [
    ...
    },
    {
      ...
      applications: ["12V/24V Battery Systems", "Automotive Applications", "High-Current DC-DC", "Low-Voltage Inverters"],
      features: ["100A high current", "Ultra-low 4mΩ Rds-on", "40V rating", "Low gate drive", "TO-220 package"],
      alternativeParts: [
        { partNumber: "MMBT75N04", brand: "MacMic", specifications: { voltage: "40V", current: "75A" }, comparison: "Lower current (75A vs 100A)", reason: "Cost optimization", useCase: "Lower current 40V apps", link: "#" }
      ],
      companionParts: [
  ...
  const additionalMOSFETProducts = [
    {
      ...
      applications: ["12V/24V Battery Systems", "Electric Vehicles", "High-Current DC", "Synchronous Rectification"],
      features: ["200A high current", "Ultra-low 1.5mΩ Rds-on", "40V rating", "SOT-227 package", "Low switching losses"],
      alternativeParts: [
        { partNumber: "MMO150A040", brand: "MacMic", specifications: { voltage: "40V", current: "150A" }, comparison: "Lower current (150A vs 200A)", reason: "Cost optimization", useCase: "Lower current 40V apps", link: "#" }
      ],
      companionParts: [
        { partNumber: "2ED300C17-S", category: "Gate Driver", description: "Dual channel gate driver", link: "#" },
    ...
    },
    {
      ...
      applications: ["48V Systems", "Industrial Motor Drives", "Power Supplies", "DC-DC Converters"],
      features: ["100A at 60V", "Low 3.5mΩ Rds-on", "Fast switching", "SOT-227 package", "Industrial grade"],
      alternativeParts: [
        { partNumber: "MMO75A060", brand: "MacMic", specifications: { voltage: "60V", current: "75A" }, comparison: "Lower current (75A vs 100A)", reason: "Cost optimization", useCase: "Lower current 60V apps", link: "#" }
      ],
      companionParts: [
    ...
    },
    {
      ...
      applications: ["100V Motor Drives", "Industrial Inverters", "Power Supplies", "High-Voltage DC-DC"],
      features: ["50A at 100V", "Low 8mΩ Rds-on", "100V rating", "SOT-227 package", "Fast switching"],
      alternativeParts: [
        { partNumber: "MMO35A100", brand: "MacMic", specifications: { voltage: "100V", current: "35A" }, comparison: "Lower current (35A vs 50A)", reason: "Cost optimization", useCase: "Lower current 100V apps", link: "#" }
      ],
      companionParts: [
    ...
    },
    {
      ...
      applications: ["12V Battery Systems", "Automotive Starter Motors", "High-Current DC Distribution", "Battery Management"],
      features: ["300A ultra-high current", "Sub-milliohm Rds-on", "30V rating", "SOT-227 package", "Maximum efficiency"],
      alternativeParts: [
        { partNumber: "MMO200A040", brand: "MacMic", specifications: { voltage: "40V", current: "200A" }, comparison: "Lower current (200A vs 300A), higher voltage (40V vs 30V)", reason: "Higher voltage rating", useCase: "40V high-current apps", link: "#" }
      ],
      companionParts: [
...
if (solutionsData.solutions.length < 4) {
  ...
  const newSolution = {
    ...
    keyComponents: [
      { partNumber: "MMG200HB120C6C", description: "200A 1200V IGBT module for traction inverters", link: "/macmic/products/igbt-modules/mmg200hb120c6c.html" },
      { partNumber: "MMO100A060", description: "100A 60V MOSFET module for DC-DC converters", link: "/macmic/products/mosfet-modules/mmo100a060.html" },
      { partNumber: "MMF100ZB120", description: "100A 1200V FRED for charging systems", link: "/macmic/products/fred-modules/mmf100zb120.html" }
    ],
    specifications: {
    ...
    coreAdvantages: [
      { title: "Automotive Qualification", description: "All components qualified to AEC-Q101 standards for automotive reliability" },
      { title: "High Efficiency", description: "Optimized devices for maximum efficiency in EV applications" },
      { title: "Wide Temperature Range", description: "Operation from -40°C to +150°C for harsh automotive environments" },
      { title: "Comprehensive Portfolio", description: "Complete range from 40V to 1200V for all automotive power needs" },
      { title: "Technical Support", description: "Dedicated automotive FAE team for application support" }
    ],
    bomList: [
      { designator: "IGBT1-6", partNumber: "MMG200HB120C6C", description: "IGBT modules for traction inverter", quantity: 6 },
      { designator: "MOSFET1-4", partNumber: "MMO100A060", description: "MOSFET modules for DC-DC", quantity: 4 },
      { designator: "D1-D6", partNumber: "MMF100ZB120", description: "FRED modules for charging", quantity: 6 }
    ],
    customerCases: [
      {
    ...
    faeInsights: {
      author: { name: "Dr. Wang Automotive Team", title: "Senior Automotive FAE", experience: "15 years", expertise: ["Automotive Power", "EV Systems", "Power Electronics"] },
      ...
      keyTakeaways: ["Use automotive-qualified devices for reliability", "Consider thermal management in design", "Plan for worst-case operating conditions"],
      commonPitfalls: ["Underestimating thermal requirements", "Not considering voltage transients", "Inadequate protection circuits"],
      bestPractices: ["Use AEC-Q101 qualified devices", "Implement proper thermal management", "Design for voltage and current margins"],
    ...
    faqs: [
      { question: "Are MacMic devices automotive qualified?", answer: "Yes, MacMic automotive devices are qualified to AEC-Q101 standards with extended temperature ranges.", decisionGuide: "Use automotive-qualified devices for all automotive applications.", keywords: ["automotive", "AEC-Q101", "qualification"] },
      { question: "What temperature range is supported?", answer: "Automotive devices support -40°C to +150°C operation.", decisionGuide: "Suitable for all automotive environments.", keywords: ["temperature", "automotive grade"] }
    ]
  };
